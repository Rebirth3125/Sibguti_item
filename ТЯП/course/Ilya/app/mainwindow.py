...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(460, 10, 800, 350))
        ...
        self.line.setGeometry(QtCore.QRect(10, 450, 1600, 21))
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.layoutWidget_2 = QtWidgets.QWidget(MainWindow)
        self.layoutWidget_2.setGeometry(QtCore.QRect(50, 30, 361, 241))
        ...
        self.gridLayout.addWidget(self._label_alphabet, 2, 0, 3, 1)
        ...
        self.gridLayout.addWidget(self._label_end_states, 5, 0, 6, 1)
        ...
        self.gridLayout.addWidget(self.end_states, 7, 1, 2, 1)
        ...
        self.gridLayout.addWidget(self.start_state, 3, 1, 5, 1)
        ...
        self.gridLayout.addWidget(self._label_states, 0, 0, 3, 1)
        ...
        self.gridLayout.addWidget(self._label_start_state, 4, 0, 3, 1)
        ...
        self.gridLayout.addWidget(self.alphabet, 2, 1, 3, 1)
        ...
        self.gridLayout.addWidget(self.states, 0, 1, 3, 1)
        self.check_chain_btn = QtWidgets.QPushButton(MainWindow)
        self.check_chain_btn.setGeometry(QtCore.QRect(40, 380, 175, 31))
        ...
        self.check_chain_btn.setStyleSheet("background-color: rgb(255, 255, 255)")
        self.check_chain_btn.setObjectName("check_chain_btn")
        self.layoutWidget1 = QtWidgets.QWidget(MainWindow)
        self.layoutWidget1.setGeometry(QtCore.QRect(40, 340, 361, 31))
        ...
        self.load_dka_btn.setStyleSheet("background-color: rgb(255, 255, 255)")
        ...
        self.save_dka_btn.setStyleSheet("background-color: rgb(255, 255, 255)")
        ...
        self.check_chain.setGeometry(QtCore.QRect(460, 410, 800, 31))
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        font.setPointSize(11)
        ...
        self.log.setGeometry(QtCore.QRect(460, 470, 800, 500))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(35, 670, 301, 21))
        ...
        self.generate_regular_grammar_btn.setGeometry(QtCore.QRect(30, 750, 301, 31))
        ...
        self.save_log_bnt.setGeometry(QtCore.QRect(200, 550, 111, 31))
        self.save_log_bnt.setObjectName("save_log_bnt")
        self.verticalLayoutWidget = QtWidgets.QWidget(MainWindow)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(30, 850, 301, 107))
        ...
        self.clear_log_bnt.setGeometry(QtCore.QRect(40, 550, 111, 31))
        self.clear_log_bnt.setObjectName("clear_log_bnt")

        self._label_initial_substring = QtWidgets.QLabel(self.layoutWidget_2)
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        font.setPointSize(11)
        self._label_initial_substring.setFont(font)
        self._label_initial_substring.setAlignment(QtCore.Qt.AlignCenter)
        self._label_initial_substring.setObjectName("_label_initial_substring")
        self.gridLayout.addWidget(self._label_initial_substring, 9, 0, 3, 1)

        self.initial_substring = QtWidgets.QLineEdit(self.layoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.initial_substring.sizePolicy().hasHeightForWidth())
        self.initial_substring.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        font.setPointSize(12)
        self.initial_substring.setFont(font)
        self.initial_substring.setText("")
        self.initial_substring.setObjectName("initial_substring")
        self.gridLayout.addWidget(self.initial_substring, 10, 1, 2, 1)

        self._label_final_subchain = QtWidgets.QLabel(self.layoutWidget_2)
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        font.setPointSize(11)
        self._label_final_subchain.setFont(font)
        self._label_final_subchain.setAlignment(QtCore.Qt.AlignCenter)
        self._label_final_subchain.setObjectName("_label_final_subchain")
        self.gridLayout.addWidget(self._label_final_subchain, 11, 0, 3, 1)

        self.final_subchain = QtWidgets.QLineEdit(self.layoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.final_subchain.sizePolicy().hasHeightForWidth())
        self.final_subchain.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        font.setPointSize(12)
        self.final_subchain.setFont(font)
        self.final_subchain.setText("")
        self.final_subchain.setObjectName("final_subchain")
        self.gridLayout.addWidget(self.final_subchain, 12, 1, 2, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_table.setText(_translate("MainWindow", "Func:"))
        self._label_alphabet.setText(_translate("MainWindow", "Alphabet"))
        self._label_end_states.setText(_translate("MainWindow", "Ends"))
        self._label_states.setText(_translate("MainWindow", "State"))
        self._label_initial_substring.setText(_translate("MainWindow", "Initial Substring"))
        self._label_final_subchain.setText(_translate("MainWindow", "Final Subchain"))
        #self._label_CHET.setText(_translate("MainWindow", "CHET"))
        self._label_start_state.setText(_translate("MainWindow", "Start"))
        ...
        self.save_log_bnt.setText(_translate("MainWindow", "Сохранить"))
        self._label_end_states_2.setText(_translate("MainWindow", "Длина цепочек\n"
" регулярной грамматики"))
        self.clear_log_bnt.setText(_translate("MainWindow", "Очистить"))
