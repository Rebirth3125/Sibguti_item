...
class Ui_StartWindow(object):
    def setupUi(self, StartWindow):
        ...
        StartWindow.setMinimumSize(QtCore.QSize(350, 300))
        StartWindow.setMaximumSize(QtCore.QSize(350, 300))
        StartWindow.setWindowIcon(self.icon)
        StartWindow.setStyleSheet("background-color: #f5f5dc;")  
        ...
        self.program_btn.setStyleSheet("background-color: #8ce970;")
        ...
        self.theme_btn.setStyleSheet("background-color: #8ce970;")
        ...
        self.about_btn.setStyleSheet("background-color: #8ce970;")
        ...
        self.exit_btn.setStyleSheet("background-color: #8ce970;")
    ...
    def retranslateUi(self, StartWindow):
        ...
        self.theme_btn.setText(_translate("StartWindow", "Задание"))
